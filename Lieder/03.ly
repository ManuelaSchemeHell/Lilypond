...
#(ly:parser-include-string (string-append "\"l" myTitel "2\"")) = \lyricmode {
  ...
  Es gibt so man -- che Stras -- se, die nim -- mer ich marschiert,
...
\relative c' {
  ...
  h h d d g'4. d8 d4. d8 fis g fis g <d h >2
}
%% Chords
#(ly:parser-include-string (string-append "\"c" myTitel "\"")) =
\chordmode {
...
\relative c'' {
  ...
  cis2 cis e cis4 e8 e cis cis cis d e4 fis e d8 cis d4 e8. e16 cis2.
}
%% Chords
#(ly:parser-include-string (string-append "\"c" myTitel "\"")) =
\chordmode {
...
#(ly:parser-include-string (string-append "\"l" myTitel "2\"")) = \lyricmode {
  ...
  die blut -- ro -- te Fah -- ne, ihr See -- leut,
