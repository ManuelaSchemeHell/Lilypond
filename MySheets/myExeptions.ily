...
chExceptionMusic = {
  <c d e f g a h>1-\markup { \sub "Dur" }
  <c d es f g as b>1-\markup { \sub "Moll natural" }
  <c d es f g as h>1-\markup { \sub "Moll harm." }
  <c d es f g a h>1-\markup { \sub "Moll mel." }
  <c des e f g as b >1-\markup { \sub "Spanish Gypsy" }
  <c d es f ges g as h>1-\markup { \sub "Algerian" }
  <c d e f fis gis b>1-\markup { \sub "Arabic " }
  <c cis e f g gis h>1-\markup { \sub "Byzantine" }
  <c cis dis e f fis gis ais>1-\markup { \sub "Eight Tone Spanish" }
  <c des e fis gis ais h>1-\markup { \sub "Enigmatic asc." }
  <c des e f gis ais h>1-\markup { \sub "Enigmatic desc." }
  <c d es f g as b>1-\markup { \sub "Geez" }
  <c d e f g as b>1-\markup { \sub "Aeolian Dominant" }
  <c des f ges b>1-\markup { \sub "Hirajoshi" }
  <c d es fis g as h>1-\markup { \sub "Hungarian" }
  <c d e fis g a b>1-\markup { \sub "Acoustic Scale" }
  <c cis f g ais>1-\markup { \sub "Japanese" }
  <c d es fis g a ais>1-\markup { \sub "Romanian Minor" }
  <c d e f g as h>1-\markup { \sub "Maqams" }
  <c es f g b>1-\markup { \sub "Minor Pentatonic" }
  <c es f fis g b>1-\markup { \sub "Minor Blues" }
  <c d es e g a>1-\markup { \sub "Major Blues" }
  <c des d es f g a b>1-\markup { \sub "Adonai Malakh" }
  <c d e fis g a b>1-\markup { \sub "Bartok" }
  <c des es f ges g as h>1-\markup { \sub "Bebop Half-Diminished" }
  <c d e f g a b h>1-\markup { \sub "Bebop Dominant" }
  <c d es e f g a b>1-\markup { \sub "Bebop Minor" }
  <c d e f g gis a h>1-\markup { \sub "Bebop Major I" }
  <c d f g b>1-\markup { \sub "Egyptian" }
  <c d es f g a b>1-\markup { \sub "Dorisch" }
  <c des es f g as b >1-\markup { \sub "Phrygisch" }
  <c d e fis g a h>1-\markup { \sub "Lydisch" }
  <c d e f g a b>1-\markup { \sub "Mixolydisch" }
  <c d es f g as b>1-\markup { \sub "Äolisch" }
  <c des es g ges as b>1-\markup { \sub "Lokrisch" }
  <c d e fis gis b>1-\markup { \sub "Ganzton" }
  <c d e fis gis ais>1-\markup { \sub "Ganzton" }
  <cis dis fis gis ais>1-\markup { \sub "Halbton" }
  ...
  <c f gis d'>1-\markup { \sub \fontsize #+1.5 "j" \super { "sus4"  \smaller \sharp "5(add9)" } }
  ...
  <c e g h d' f' a'>1-\markup { \sub \fontsize #+1.5 "j" \super "13" }
  <c e g h d' f'>1-\markup { \sub \fontsize #+1.5 "j" \super "11" }
  <c e g h d' fis'>1-\markup { \sub \fontsize #+1.5 "j"  \super { \smaller \sharp "11" } }
