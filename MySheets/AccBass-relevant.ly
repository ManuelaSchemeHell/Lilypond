...
#(define (get-Chord p n)
   ...
   (let* ((i (get-Index p)))
     ...
     (cond
      ...
      ((= 3 n) (list-ref (pitchlist-of-chordlist oDur) i))
      ((= 2 n) (list-ref (pitchlist-of-chordlist oMoll) i))
      ((= 1 n) (list-ref (pitchlist-of-chordlist oSept) i))
      ((= 0 n) (list-ref (pitchlist-of-chordlist oVerm) i))
      (else #f)
      )))
...
#(write-me "list " (p-diff-min Terz-circle))
     ...
     #{
       {
         <<
           \context Staff = "MyChords" {
             ...
             \override Staff.TextScript.extra-offset=#'(-3 . 3)
             % \override Score.RehearsalMark.Y-offset = #10
             % \override Score.RehearsalMark.staff-padding=#20
             <>^\markup {
